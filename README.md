...
- Find the Windows version. It might look like `Axis_windows.exe` or similar.
- Click on the `.exe` file to start your download.
...
- If your system asks, confirm that you want to run this file.
...
- Open the config file located at `C:\Users\YourName\.axis\config.toml` after installation.
- Change prompt styles, history size, or jump settings by editing this file with a simple text editor like Notepad.
